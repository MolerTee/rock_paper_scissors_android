...
public class Game
{
    ...
    public Game() {
        random = new Random();
        computerChoice = random.nextInt(3 - 1) + 1;
        playerChoice = 0;
    }
    ...
    public String runGame(int playerChoice, int computerChoice){
        if (playerChoice == 1 && computerChoice == 1) {
            ...
            return "player chose paper computer chose rock so you win";
            ...
            return "player chose scissors computer chose rock so you lose";
        } else if (playerChoice == 3 && computerChoice == 2) {
            return "player chose scissors computer chose paper so you win";
